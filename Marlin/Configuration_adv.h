 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD //rox
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.55        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       760        // (mA) RMS current. Multiply by 1.414 for peak current. //rox
